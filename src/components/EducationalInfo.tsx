      ...
      <CardContent>
        <div className="text-base text-gray-700 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
            <div>
              <h4 className="font-semibold text-blue-700 mb-2 text-base">Risk Level Classification</h4>
            ...
            <div>
              <h4 className="font-semibold text-blue-700 mb-2 text-base">Evidence Quality</h4>
              <p className="mb-1">The confidence score (1-5) reflects the quality and consistency of evidence supporting the interaction:</p>
              <ul className="list-disc pl-5 space-y-1">
